...
<body class="tournaments-page register">
	...
	<div class="container-fluid no-padding">
		<div class="slider col-lg-12" style="background: url('/images/fifa1.jpg') !important; background-size: cover !important; background-position: center; background-repeat: no-repeat;">
			<h1>Register</h1>
			<strong><a href="#">Home</a> <span>/ Register</span></strong>
		</div>
	</div>
		...
		<section class="container">
			...
			<form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <p>
                    ...
                    <input type="text" name="username" required autofocus class="register">
                ...
                <p>
					<label>Name:</label>
                    <input type="text" name="name" required class="register">
                    @if ($errors->has('name'))
                        <span class="help-block" style="color: #ff8800;">
				...
				<p>
					<label>Email:</label>
                    <input type="email" name="email" value="{{ old('email') }}" class="register">
                    @if ($errors->has('email'))
                        <span class="help-block" style="color: #ff8800;">
				...
				<p>
                    ...
                    <input type="password" name="password" required value="{{ old('password') }}" class="register">
                ...
                <p>
                    ...
                    <input type="password" name="password_confirmation" required value="{{ old('password_confirmation') }}" class="register">
                ...
                <p>
                    <label>Avatar:</label>
                    <input type="file" name="avatar" required class="register">
				...
				<p class="submit">
					<button type="submit" class="button-medium">SIGN UP</button>
				</p>
